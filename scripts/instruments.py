...
magellan_tele = Telescope(diam=650, f_num=11, psf_type='airy')
magellan_tele_lightspeed = Telescope(diam=650, f_num=2, psf_type='gaussian', spot_size=20)

hale_tele = Telescope(diam=510, f_num=3.29, psf_type='gaussian', spot_size=20)
winter_tele = Telescope(diam=100, f_num=6.0, psf_type='gaussian', spot_size=20)
...
sloan_u = S.ObsBandpass('sdss,u')
sloan_g = S.ObsBandpass('sdss,g')
sloan_r = S.ObsBandpass('sdss,r')
...
filter_dict_gb = {'None': no_filter, 'Johnson U': johnson_u,
                  ...
                  'Johnson R': johnson_r, 'Johnson I': johnson_i,
                  'Johnson J': johnson_j, 
                  'Sloan U': sloan_u, 'Sloan G': sloan_g, 'Sloan R': sloan_r,
                  'SWIR (900-1700 nm 100%)': swir_filter,
                  'Visible (400-700 nm 100%)': vis_filter}
